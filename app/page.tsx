...
import { getExperienceInfo, getTechnicalSkillsInfo, getPersonalInfo } from "@/lib/data"
              ...
              <Card className="bg-zinc-900/70 border-zinc-800 backdrop-blur-sm">
                <CardContent className="p-4 sm:p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                    {technicalSkills.design && technicalSkills.design.length > 0 && (
                    ...
                    {technicalSkills.development && technicalSkills.development.length > 0 && (
                    ...
                    {technicalSkills.uxMethods && technicalSkills.uxMethods.length > 0 && (
                    ...
                    {technicalSkills.softSkills && technicalSkills.softSkills.length > 0 && (
                ...
                <CardContent className="p-4 sm:p-6">
                  ...
                  <div className="space-y-3">
                    {projects.map((project, index) => (
                      <AnimatedSection key={project.id} animation="fade-up" delay={75 * (index + 1)}>
                        <ProjectCard
                          title={project.title}
