    ...
    <Card className="bg-zinc-900/70 border-zinc-800 backdrop-blur-sm">
      <CardContent className="p-4 sm:p-6">
        ...
        <div className="space-y-6 sm:space-y-8">
          ...
          {credentialsInfo.certifications && credentialsInfo.certifications.length > 0 && (
          ...
          {/* Education */}
          {credentialsInfo.education && credentialsInfo.education.length > 0 && (
          ...
          {/* Skills & Expertise */}
          {credentialsInfo.skills && credentialsInfo.skills.length > 0 && (
